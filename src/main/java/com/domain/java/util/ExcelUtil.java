...
public class ExcelUtil {
                    ...
                    switch (cell.getCellType()) {
                        ...
                        case Cell.CELL_TYPE_NUMERIC:
                            if (DateUtil.isCellDateFormatted(cell)) {
                                ...
                                if (date != null) {
                                    value = com.domain.java.util.DateUtil.时分秒.format(date);
                                } else {
                                    value = "";
                                }
                            } else {
        ...
        while (iterator.hasNext()) {
            ...
            for (int column = 0; column < heads.length; column++) {
                ...
                if (obj instanceof Boolean) {
                    ...
                    Date date = (Date) obj;
                    text = com.domain.java.util.DateUtil.时分秒.format(date);
                } else {
                    text = obj.toString();
                }
                if (text != null) {
    ...
    public static void main(String[] args) {
        ...
        writeExcel(fileName, heads, properties, dataList);
        ...
        writeExcel(fileName, heads, properties, dataList001);
    }
}
