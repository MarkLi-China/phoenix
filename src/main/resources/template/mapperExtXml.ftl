...
<mapper namespace="${cfg.base.mapperExt}.${table.tableMeta.entityName}Dao">
  <resultMap id="BaseResultMap" type="${cfg.base.mapperModel}.${table.tableMeta.entityName}"
             extends="${cfg.base.mapper}.${table.tableMeta.entityName}Mapper.BaseResultMap">
