...
<div class="toolbar">
  <boss:checkAuth url="">
    <a href="${'$'}{root}/${table.tableMeta.referenceName}/edit.html?cType=1&id=${'$'}{detail.${table.tableMeta.primaryKeys[0].name}}"
       name="${table.tableMeta.referenceName}" id="${table.tableMeta.referenceName}"
